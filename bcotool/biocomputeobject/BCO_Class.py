...
class ErrorDomain:
    ...
    def validate(this, empirical_Error, algorithmic_Error):
        argTypes = {
            empirical_Error : EmpiricalError,
            algorithmic_Error : AlgorithmicError
        }
...
class EmpiricalError:
    ...
    def validate(this, empError):
        if empError is None or not isinstance(empError, EmpiricalError):
            return False
...
class AlgorithmicError:
    ...
    def validate(this, algError):
        if algError is None or not isinstance(algError, EmpiricalError):
            return False
...
class IODomain:
    ...
    def validate(this, input_Subdomain, output_Subdomain):
        if input_Subdomain is None or not isinstance(input_Subdomain, InputSubdomain):
            return False
        elif output_Subdomain is None or not isinstance(output_Subdomain, OutputSubdomain):
            return False
        return True
...
class URI:
    ...
    def validate(this, uri_str):
        if uri_str is None or not isinstance(uri_str, str):
            return False
        return True
...
BCO_000139 = BioComputeObject(meta_139, use_139, prov_139, excn_139, None, descrpt_139, None, io_139)
...
#print(BCO_000139.validate(badMeta, use_139, prov_139, excn_139, None, descrpt_139, None, io_139))
print(BCO_000139.validate(meta_139, use_139, prov_139, excn_139, None, descrpt_139, None, io_139))
print("Finished")
